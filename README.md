...
Copiar la variable documentada en `.env.example` a `.env.local` para cambiar la URL base
en desarrollo. En Vercel, definir `NEXT_PUBLIC_SITE_URL` con el dominio de producción.
