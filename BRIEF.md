...
Cloudflare Images con IDs `andrea-media-001` a `andrea-media-064` más cuatro reemplazos a
pedido de la artista: `andrea-media-065` (Cintas gota), `andrea-media-066` (Suspensión
capilar), `andrea-media-067` (hero anterior) y `andrea-media-068` (hero vigente,
`upscalemedia-transformed.png` de 3344×1882 con el rostro centrado).
